...
All emitted `.conf` content must be generated through the canonical config builder described in [config-generation-contract.md](config-generation-contract.md).
