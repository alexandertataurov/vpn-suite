...
**Quick checklist:** Port open → Forward=1 → NAT/MASQUERADE for tunnel subnet → Reply routes → MTU consistent. See [no-traffic-troubleshooting.md](no-traffic-troubleshooting.md) for deeper diagnostics.
