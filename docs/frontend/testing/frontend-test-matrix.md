...
| /billing | Billing tabs (subscriptions, payments) | Authenticated | Navigate, switch tabs | Subscriptions/payments | Billing API | e2e | P1 |
...
- Admin: /audit, /settings, /styleguide lack dedicated smoke
