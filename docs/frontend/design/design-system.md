...
- Token source: `apps/admin-web/src/design-system/tokens/tokens.css` (admin). Miniapp: `apps/miniapp/src/design-system/styles/tokens/base.css`, `apps/miniapp/src/design-system/styles/theme/consumer.css`, `apps/miniapp/src/design-system/styles/theme/telegram.css`.

## Miniapp design-system foundations

- **Token stack (canonical)**:
  - Base tokens: `apps/miniapp/src/design-system/styles/tokens/base.css`.
  - Consumer themes: `apps/miniapp/src/design-system/styles/theme/consumer.css` (`html[data-theme="consumer-dark" | "consumer-light"]`).
...
- **Typography**:
  ...
  - Miniapp aliases: `--ds-font-*` tokens in `telegram.css` and `TYPOGRAPHY_TOKENS` in `apps/miniapp/src/design-system/tokens/typography.ts`.
...
- **TypeScript / TSX**:
  ...
  - Enforce that new miniapp components live under `apps/miniapp/src/design-system` when they are reused across pages; page files in `apps/miniapp/src/pages` should mostly compose existing primitives/patterns.
- **CSS**:
