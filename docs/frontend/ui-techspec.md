...
> **Note:** Canonical tokens: [design/design-system.md](design/design-system.md), [design/typography-tokens.md](design/typography-tokens.md). Use `var(--token-name)`; avoid hardcoded values.
