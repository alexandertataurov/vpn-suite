...
- `README.md`
  ...
  - [ ] Link to:
    - [docs/ops/install-ubuntu-lts.md](../ops/install-ubuntu-lts.md)
...
- [ ] First-install guide (Ubuntu LTS) — done: [docs/ops/install-ubuntu-lts.md](../ops/install-ubuntu-lts.md).
- [ ] Hardening baseline (Ubuntu LTS) — done: [docs/ops/hardening-reference-ubuntu.md](../ops/hardening-reference-ubuntu.md).
