...
- Miniapp Storybook stories live under `apps/miniapp/src/stories/` (design-system stories mirror `src/design-system/` under `src/stories/design-system/`) and must use canonical titles such as `Foundations/*`, `Primitives/*`, `Patterns/*`, `Layouts/*`, `Pages/*`, and `States/*`.
