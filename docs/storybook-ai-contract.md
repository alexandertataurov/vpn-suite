...
- Miniapp Storybook stories are colocated with components under `apps/miniapp/src/**` and must use canonical titles such as `Foundations/*`, `Primitives/*`, `Patterns/*`, `Layouts/*`, `Pages/*`, and `States/*`.
