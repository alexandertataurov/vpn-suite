...
| `/subscriptions` | `frontend/admin/src/pages/Subscriptions.tsx` | TableSection, Table, Badge, Button, PageError |
| `/payments` | `frontend/admin/src/pages/Payments.tsx` | TableSection, Table, Badge, Button, PageError |
...
| TableSection | `frontend/admin/src/components/TableSection.tsx` | Devices, Subscriptions, Audit, Payments | Section + title/actions + children + optional Pagination |
...
| ServersEmptyState | `frontend/admin/src/components/servers/ServersEmptyState.tsx` | Servers | Empty state variant |
...
- **Empty:** EmptyState (Servers, Users, Styleguide); `.table-empty` in Table and several pages; ServersEmptyState on Servers.
...
- Audit / Subscriptions / Payments: TableSection + Table + pagination.
