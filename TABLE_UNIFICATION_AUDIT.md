...
- Servers `/servers`
  - `frontend/admin/src/pages/Servers.tsx`
    - API: manual `<table>` inside `DataTable` (not `Table`)
...
- Billing `/billing`
  ...
  - `frontend/admin/src/pages/billing/SubscriptionsTab.tsx`
    ...
    - Custom CSS: none beyond shared
    - Performance: moderate rows
  - `/payments` and `/subscriptions` routes are redirects to `/billing?tab=...`

- Payments `/payments` (redirect)
  - `frontend/admin/src/pages/Payments.tsx`
    - API: `Table` + `Column<T>` inside `TableSection`
    - Features: numeric, truncate
    - Sorting: none
    - Pagination: `TableSection` pagination
...
- Subscriptions `/subscriptions` (redirect)
...
- Integrations `/integrations/outline`
  - `frontend/admin/src/pages/OutlineIntegrations.tsx`
    - API: `Table` + `Column<T>` inside `TableSection`
    - Features: truncation, actions
    - Sorting: none
    - Pagination: unknown
    - Custom CSS: none beyond shared
    - Performance: moderate rows
...
- `frontend/shared/src/ui/table/DataTable.tsx`
...
| Payments page | Migrate to shared `Table` (already) | Use new empty/loading API |
| Subscriptions page | Migrate to shared `Table` (already) | Use new empty/loading API |
...
| Outline Integrations | Migrate to shared `Table` (already) | Use new column helpers |
