...
**Archive:** See [[07-docs/observability/archive-pipeline|archive-pipeline.md]]. Loki: S3 schema or sync job. Tempo: S3/GCS backend. Prometheus: document migration path (Thanos/VM/Mimir).
