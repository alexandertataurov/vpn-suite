...
| 3.8 | OpenAPI/TS types for analytics endpoints | Todo | [[07-docs/observability/analytics-api|analytics-api.md]] |
...
| 5.3 | amnezia-awg2: document wg-exporter deployment | Todo | [[07-docs/observability/services/amnezia-awg2|amnezia-awg2.md]] |
...
| 6.4 | SLO dashboards (availability, latency) | Todo | [[07-docs/observability/slos|slos.md]] |
...
| # | Task | Status | Notes |
|---|------|--------|-------|
| 8.1 | verification.md | Done | [[07-docs/observability/verification|verification.md]] |
