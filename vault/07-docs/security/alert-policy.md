...
|-------|-----------|----------|---------|
| AdminApiDown | up == 0 | critical | [[07-docs/security/incident-response-runbook|incident-response]] |
| HighErrorRate | 5xx rate >5% | warning | [[07-docs/ops/runbook|ops runbook]] |
...
- [[07-docs/security/incident-response-runbook|incident-response-runbook.md]] — Compromise, key rotation, server lag
- [[07-docs/ops/runbook|../ops/runbook.md]] — Ops procedures
