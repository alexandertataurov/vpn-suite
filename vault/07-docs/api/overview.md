...
OpenAPI (canonical): `openapi/openapi.yaml` (generated by `./manage.sh openapi`).
...
- **As-built surface inventory:** `docs/api/as-built-api-spec.md`
- **Schema summary:** `docs/api/db-schema-spec.md`
- **OpenAPI:** `openapi/openapi.yaml` (exported by `./manage.sh openapi`)
...
`/api/telemetry/docker/*` is a compatibility alias for `/api/v1/telemetry/docker/*` (deprecated but still implemented).
