...
### 6. Документация — DONE
- [x] [[07-docs/bot/bot-menu-architecture|bot-menu-architecture.md]] обновлён: inline меню, nav:*/act:*/dev:*.
...
6. Обновить [[07-docs/bot/bot-menu-architecture|bot-menu-architecture.md]].
