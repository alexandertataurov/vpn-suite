...
- [[07-docs/specs/operator-dashboard-spec|operator-dashboard-spec.md]] — Metrics inventory, PromQL, layout grid
- [[07-docs/specs/telemetry-spec|telemetry-spec.md]] — Metric → source → UI
