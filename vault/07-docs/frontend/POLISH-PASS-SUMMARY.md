...
- **Documentation:** [[07-docs/frontend/ui-techspec|ui-techspec.md]], [[07-docs/frontend/design/UI-ALIGNMENT-DECISION-LOG|design/UI-ALIGNMENT-DECISION-LOG.md]], [[07-docs/frontend/adaptive-ui|adaptive-ui.md]], [[07-docs/frontend/miniapp-layout-architecture|miniapp-layout-architecture.md]], release checklist (contrast, focus, reduced-motion, 44px CTA).
...
- **Miniapp:** [[07-docs/frontend/miniapp-layout-architecture|miniapp-layout-architecture.md]] defines 600/900px and max-width; verify Plan grid (1 col → 2 col), Checkout and Referral on narrow viewports, and bottom nav safe area on notched devices.
