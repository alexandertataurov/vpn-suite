...
Semantic tokens in `tokens.css`; see [[07-docs/frontend/design/design-system|design/design-system.md]] and [[07-docs/frontend/design/typography-tokens|design/typography-tokens.md]] for token reference. Telemetry severity: pair **color + icon** (healthy=green+check, warning=amber+warning, critical=red+alert, unknown=gray+minus).
...
- **A11y:** Keyboard nav, `:focus-visible`, ARIA landmarks, 44px min touch targets on XS/SM. See [[07-docs/frontend/adaptive-ui-test-plan|adaptive-ui-test-plan.md]].
