...
pnpm --filter miniapp exec playwright test e2e/responsive-layout.spec.ts --project=chromium
pnpm --filter miniapp exec playwright test e2e/visual-regression.spec.ts --project=chromium
```
