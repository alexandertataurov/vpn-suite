...
Each layer has strict responsibilities. In this repo, implementation lives under `primitives/`, `components/`, `patterns/`, `layouts/`, and `recipes/`; see the design-system [[07-docs/frontend/miniapp-design-system/README|README]] for the folder map and "I want to…" table.
...
- [[07-docs/frontend/miniapp-design-system/enforcement-checklist|Design System Enforcement Checklist]]
- [[07-docs/frontend/miniapp-design-system/README|Miniapp Design System README]]
