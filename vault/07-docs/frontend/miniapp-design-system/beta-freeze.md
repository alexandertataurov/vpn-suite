...
Scope: `apps/miniapp/src/design-system`
...
- Recommended patterns:
  - `LabeledControlRow` (`design-system/recipes/LabeledControlRow.tsx`)
  - `DataGrid` (`design-system/patterns/ui/DataGrid.tsx`) for denser tabular content.
- Rule:
...
- Canonical badge: `StatusChip` (`design-system/patterns/ui/StatusChip.tsx`).
  - Variants: `active`, `paid`, `info`, `pend` (alias `pending`), `pending`, `offline`, `blocked`.
- Rule:
...
- Inline errors: `InlineAlert` (`design-system/components/feedback/InlineAlert.tsx`).
...
- Skeletons: `Skeleton` (`design-system/components/feedback/Skeleton.tsx`).
