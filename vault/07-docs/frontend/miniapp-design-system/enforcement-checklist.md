...
- `PASS`: architecture-impacting changes keep [[07-docs/frontend/miniapp-design-system/architecture|architecture.md]] in sync.
- `PASS`: new reusable page wrappers are documented in [[07-docs/frontend/miniapp-design-system/README|README.md]].
...
- `PASS`: mobile UI changes follow [[07-docs/frontend/miniapp-design-system/mobile-platform-guidelines|mobile-platform-guidelines.md]].
