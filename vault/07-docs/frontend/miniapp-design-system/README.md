...
Miniapp uses **consumer-light** | **consumer-dark** only. See [[07-docs/frontend/miniapp-design-system/THEME-RUNTIME|THEME-RUNTIME.md]] for load order and deprecations.

## Architecture

The design system follows a **layered model**. Each layer has strict responsibilities; see **[[07-docs/frontend/miniapp-design-system/architecture|architecture.md]]** for the full guide, **[[07-docs/frontend/miniapp-design-system/enforcement-checklist|enforcement-checklist.md]]** for PR/CI checks, and **[[07-docs/frontend/miniapp-design-system/mobile-platform-guidelines|mobile-platform-guidelines.md]]** for iOS/Android-compatible mobile UI rules.
...
**Scrollable page content** (everything inside `.page`) is specified in **[[07-docs/frontend/miniapp-design-system/content-library|content-library.md]]**. That document is the canonical reference for:
