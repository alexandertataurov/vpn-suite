...
**Reference:** [[07-docs/frontend/admin-design-system/WCAG_2.0|WCAG_2.0.md]], [[07-docs/frontend/admin-design-system/design-system#13-accessibility|design-system.md §13]], W3C How to Meet WCAG (Context7).

**Scope:** `apps/admin-web` (design-system primitives, widgets, layout, feature pages).

**Target:** Level AA.

**Last reviewed:** 2025-03-05 (code audit + 3.3.3/3.3.4 remediation).

**Coverage:** This report addresses 100% of [[07-docs/frontend/admin-design-system/WCAG_2.0|WCAG_2.0.md]]: all success criteria (1.1.1–4.1.2), AAA/out-of-scope callouts, Engineering Implementation Rules (Must Pass, Required Testing, Design System Rules table), and the full "UI Accessibility Design Rules" section (1–12 + Production Rule).
...
Maps to **WCAG_2.0.md** “UI Accessibility Design Rules” section (typography, contrast, focus, targets, spacing, motion, forms, layout, icons, charts, contracts, testing). Verified against `apps/admin-web` (tokens, primitives, shell, typography CSS).
...
*Report generated against WCAG 2.0 and project [[07-docs/frontend/admin-design-system/WCAG_2.0|WCAG_2.0.md]]. Context7 used for W3C “How to Meet WCAG” techniques (bypass blocks, page titled, name/role/value, labels).*
