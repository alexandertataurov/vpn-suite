...
> Design decisions follow [[07-docs/frontend/admin-design-system/design-principles|Design Principles]]; read them before extending the system.
>
...
Every interactive component must be keyboard-navigable and screen-reader-compatible. Accessibility is not optional — it is part of the definition of done. For a full WCAG 2.0 AA checklist and implementation rules, see [[07-docs/frontend/admin-design-system/WCAG_2.0|WCAG 2.0 UI Compliance Guide]].
...
**Decision framework:** When facing a design decision, use the [[07-docs/frontend/admin-design-system/design-principles#13-decision-framework|Decision Framework]] in Design Principles (§13): use the system first, apply the six principles, name the state, design for the operator's next action, design failure modes, and remove non-informative elements.
