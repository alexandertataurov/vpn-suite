...
- **Deprecated CSS classes** (e.g. `ref-action-btn`, `dashboard-muted`): Document in [[07-docs/frontend/design/ui-guide|ui-guide.md]] under "Don't"; replace with shared components or token-based classes. No deadline; remove when the last usage is migrated.
