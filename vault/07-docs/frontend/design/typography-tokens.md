...
- Admin: `apps/admin-web/src/design-system/tokens/tokens.css` + `apps/admin-web/src/design-system/typography/typography.css`
- Miniapp: `apps/miniapp/src/design-system/styles/tokens/base.css`, `theme/consumer.css`
...
- Admin typography primitives live under `apps/admin-web/src/design-system/` (e.g. `typography.tsx` + primitives).
