...
Test plan and accessibility checklist for the admin adaptive/responsive UI. See also [[07-docs/frontend/adaptive-ui|adaptive-ui.md]] for breakpoints and layout.
...
> **Tip:** Optional CI: `@axe-core/playwright` on critical pages; Lighthouse budget for LCP/CLS.
