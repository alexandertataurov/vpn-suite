...
**Data sync:** [[07-docs/ops/local-first-data-sync|local-first-data-sync.md]]  
**Mode switching:** [[07-docs/ops/local-dev-modes|local-dev-modes.md]] — local full-stack, frontend+beta API, beta deployed
