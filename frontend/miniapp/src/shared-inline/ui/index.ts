...
export { Panel, Panel as Card, PanelHeader, PanelBody } from "./display/Panel";
...
export { InlineAlert, InlineAlert as Alert } from "./feedback/InlineAlert";
...
export { Modal, ConfirmModal, ConfirmDanger, ConfirmDanger as ConfirmDialog } from "./feedback/Modal";
...
export { Stat, Stat as StatCard } from "./display/Stat";
