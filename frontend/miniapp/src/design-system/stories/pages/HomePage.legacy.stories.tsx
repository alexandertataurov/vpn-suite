/**
 * Legacy alias for pages-home--home (bookmarks, Chromatic, HMR recovery).
 * Canonical stories live in HomePage.stories.tsx under Pages/Contracts/Home.
 */
...
const meta: Meta<{
  ...
  title: "Pages/Contracts/Home (Legacy)",
  tags: ["autodocs"],
  argTypes: {
    state: {
      control: "select",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Legacy alias (pages-home--home). See Pages/Contracts/Home for canonical stories.",
      },
    },
  },
};
