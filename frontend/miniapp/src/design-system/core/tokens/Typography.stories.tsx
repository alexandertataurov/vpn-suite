...
export const Reference: Story = {
  render: () => (
    ...
    >
      ...
      >
        <TwoColumn>
          <UsageExample title="Hero card" description="Hero typography mixes headline, metadata, and status in one surface.">
            <ModernHeroCard
              status="warning"
              icon={<IconShield size={36} strokeWidth={2} />}
              title="Tunnel active"
              description="Traffic is protected, but latency is elevated and route quality is degraded."
            />
          </UsageExample>
