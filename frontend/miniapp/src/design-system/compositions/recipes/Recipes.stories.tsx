...
import { DataCell, DataGrid, SelectionCard, StatusChip } from "@/design-system/compositions/patterns";
import { LabeledControlRow, FaqDisclosureItem, PageCardSection, PageHeaderBadge, SettingsActionRow, SnapCarousel, ModernHeader } from "@/design-system/compositions/recipes";
import { Box, Text } from "@/design-system/core/primitives";
import { IconAlertTriangle, IconGlobe } from "@/design-system/icons";
import { StoryCard, StoryPage, StorySection, TokenTable, TwoColumn, UsageExample, ValuePill } from "@/design-system/utils/story-helpers";
...
function PlanRailExample() {
  ...
  return (
    <RecipeStoryFrame>
      <LabeledControlRow label={<Text variant="meta">Billing cycle</Text>}>
      ...
      >
        <TwoColumn>
          <StoryCard title="PageHeaderBadge" caption="Badges stay compact enough for the page header action slot and can pulse for live state.">
            <RecipeStoryFrame>
              <ModernHeader title="Account security" subtitle="Recovery and access posture" showSettings={false} />
              <BadgeTonesExample />
            </RecipeStoryFrame>
          </StoryCard>
