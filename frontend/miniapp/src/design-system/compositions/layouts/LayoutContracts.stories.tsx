...
import { StoryCard, StoryPage, StorySection, ValuePill } from "@/design-system/utils/story-helpers";
...
export const DangerZoneLayout: Story = {
  ...
  render: () => (
    <PageScaffold header={<ModernHeader title="Settings" />}>
  ...
  render: () => (
    <div className="layout-story-mobile-grid">
      <ContractShellPreview
        ...
        element={
          <PageScaffold header={<ModernHeader title="Settings" label="Page Scaffold" />}>
      ...
      <ContractShellPreview
        ...
        element={
          <PageScaffold header={<ModernHeader title="Device detail" label="Devices" onBack={() => {}} />}>
...
export const KeyboardRealInput: Story = {
  ...
  render: () => (
    <PageScaffold header={<ModernHeader title="Device profile" />}>
...
function ScrollContractPage({ rows }: { rows: number }) {
  return (
    <PageScaffold header={<ModernHeader title="Scroll contract" onBack={() => {}} />}>
...
function ShellAnchorPage({
  ...
  return (
    <PageScaffold
      header={<ModernHeader title={title} onBack={detail ? () => {} : undefined} />}
      className={
        detail
