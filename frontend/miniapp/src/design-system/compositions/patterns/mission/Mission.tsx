...
import type { ButtonProps, ButtonTone } from "../../../components/Button";
import { percentClass } from "@/lib";
...
export function MissionCard({
  ...
  const Component = as;
  const isPressable = typeof props.onClick === "function";
  return (
    <Component
      className={joinClasses(
        "card",
        "mission-card",
        CARD_EDGE_CLASS_MAP[tone],
        isPressable && "motion-pressable-surface",
        className
      )}
...
export interface MissionSecondaryButtonProps
  extends Omit<ButtonProps, "children" | "variant" | "size" | "tone"> {
  children: ReactNode;
}
...
export function MissionSecondaryLink({
  ...
  return (
    <Link className={joinClasses(getButtonClassName("secondary", "md"), className)} data-pressable="true" {...props}>
      {children}
    </Link>
  );
}
...
export function MissionSecondaryAnchor({
  ...
  return (
    <a className={joinClasses(getButtonClassName("secondary", "md"), className)} data-pressable="true" {...props}>
      {children}
    </a>
  );
}
...
export function MissionOperationArticle({
  ...
  return (
    <Component
      className={joinClasses("op", OP_EDGE_CLASS_MAP[tone], isPressable && "motion-pressable-surface", className)}
      data-pressable={isPressable ? "true" : undefined}
      {...props}
    >
      <MissionOperationContent
