...
export function MissionSecondaryButton({
  ...
  return (
    <Button variant="secondary" size="lg" type={type} className={className} {...props}>
      {children}
    </Button>
  );
}
...
export function MissionPrimaryLink({
  ...
  return (
    <Link
      className={joinClasses("btn-primary", PRIMARY_BUTTON_TONE_CLASS_MAP[tone], className)}
      {...props}
    >
      {children}
    </Link>
...
export function MissionSecondaryLink({
  ...
  return (
    <Link className={joinClasses("btn-secondary", className)} {...props}>
      {children}
    </Link>
  );
}
...
export function MissionSecondaryAnchor({
  ...
  return (
    <a className={joinClasses("btn-secondary", className)} {...props}>
      {children}
    </a>
  );
}
