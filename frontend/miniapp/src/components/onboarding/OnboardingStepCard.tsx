          ...
          <ModernHeroCard
            ...
            actions={
              <div className="stack">
                ...
                {!hasActiveDevice ? (
                  <InlineAlert variant="warning" title={t("onboarding.get_config_first")} body={t("onboarding.get_config_first_body")} />
                ) : hasDetectedActivity ? (
                  <InlineAlert variant="success" title={t("onboarding.setup_activity_detected_title")} body={detectedIp ? t("onboarding.setup_activity_detected_message_with_ip", { ip: detectedIp }) : t("onboarding.setup_activity_detected_message_generic")} />
                ) : (
                  <InlineAlert variant="info" title={t("onboarding.what_happens_next_title")} body={t("onboarding.what_happens_next_message")} />
                )}
              </div>
            }
          />
