...
import { PrimitiveBadge, Button, Panel, Skeleton } from "@vpn-suite/shared/ui";
...
export function AlertsPanel({ items, isLoading, error }: Props) {
  return (
    <Panel as="section" variant="outline" aria-label="Alerts">
      <div className="ref-section-head">
        <h3 className="ref-settings-title">Alerts</h3>
      </div>
