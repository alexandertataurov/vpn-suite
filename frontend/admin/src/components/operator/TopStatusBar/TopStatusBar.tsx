  ...
  return (
    <div className="operator-health-strip operator-top-bar-health" aria-label="System health">
      ...
      <div className="operator-health-block operator-health-block--activity" aria-label="Activity metrics">
        ...
        <div className="operator-topbar-cell" title="Peers with recent handshake activity">
          <span className="operator-topbar-label">Peers</span>
          <span className="operator-topbar-value operator-topbar-value--secondary">
            {data.peers_active != null ? data.peers_active : "—"}
          </span>
        </div>
        <div className="operator-topbar-cell" title="Total cluster throughput">
      ...
      <div className="operator-health-block operator-health-block--performance" aria-label="Performance">
        <div className="operator-topbar-cell" title="Average latency (ms)">
          <span className="operator-topbar-label">Latency</span>
          <span className="operator-topbar-value operator-topbar-value--secondary">
            {data.avg_latency_ms != null ? `${Math.round(data.avg_latency_ms)}ms` : "—"}
          </span>
        </div>
        <div className="operator-topbar-cell" title="Error rate">
