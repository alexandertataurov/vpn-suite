...
import { TimeSeriesPanel } from "@/components";
...
export function ContainerDetailsPanel({
  ...
  if (container == null) {
    return (
      <Card as="section" variant="outline" aria-label="Container details">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Container details</Heading>
        </div>
