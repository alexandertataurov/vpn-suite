...
import { Button, Card, SearchInput, Skeleton, CopyButton, LiveIndicator } from "@/design-system";
...
export function LogsViewer({ logs, isLoading, canReadLogs, error }: Props) {
  ...
  return (
    <Card as="section" variant="outline" aria-label="Logs">
      <div className="ref-section-head">
        <Heading level={3} className="ref-settings-title">Logs</Heading>
