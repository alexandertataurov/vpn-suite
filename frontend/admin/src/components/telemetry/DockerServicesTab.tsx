...
import { DataSourceHealthStrip, TelemetryKpiGrid, TableSection } from "@/components";
...
export function DockerServicesTab() {
  ...
  if (dockerUnavailable || dockerNotConfigured) {
    return (
      <Card as="div" variant="outline" data-testid="docker-telemetry-unavailable">
  ...
  return (
    <div className="ref-telemetry-stack">
      ...
      />
      <Card as="section" variant="outline" aria-label="Docker controls">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Live controls</Heading>
      ...
      <Card as="section" variant="outline" aria-label="Metrics controls">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Metrics range</Heading>
        </div>
        <div className="actions-row flex-wrap">
          <Select
            label="Range"
