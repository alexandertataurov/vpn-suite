...
import { PrimitiveBadge, Button, Card, Alert, PageError, Select, Skeleton, Table, RelativeTime, useToast } from "@/design-system";
import { serverHealthBadge } from "../../utils/statusBadges";
import { ClusterHealthCharts, DataSourceHealthStrip, TelemetryKpiGrid, LiveDegradedBanner } from "@/components";
import type {
...
import { CopyableId, Heading } from "@/design-system";
...
export function VpnNodesTab({ regionFilter }: { regionFilter: string }) {
  ...
  const serversColumns = useMemo(
    () => [
      { key: "id", header: "Node", truncate: true, mono: true, width: 110, render: (r: ServerOut) => <CopyableId value={r.id} /> },
  ...
  return (
    <div className="ref-telemetry-stack">
      <Card as="section" variant="outline" aria-label="Live cluster health">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Live cluster health</Heading>
        </div>
        <LiveDegradedBanner />
        {operatorQuery.error && (
          <Alert
      ...
      <Card as="section" variant="outline" aria-label="Server stream">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Server stream</Heading>
      ...
      <Card as="section" variant="outline" aria-label="Region health matrix">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Region health matrix</Heading>
        </div>
      ...
      <Card as="section" variant="outline" aria-label="Server status list">
        <div className="ref-section-head">
          <Heading level={3} className="ref-settings-title">Server status list</Heading>
        </div>
        <p className="ref-settings-text">
