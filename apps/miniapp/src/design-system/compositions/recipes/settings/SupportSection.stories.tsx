  ...
  legalLinks: [
    {
      ...
      description: "How the mini app handles account and billing data",
      onClick: () => {},
    },
    {
      title: "User agreement",
      description: "Terms for access, billing, and refunds",
      onClick: () => {},
    },
  ],
  contactSupportTitle: "Contact support",
  contactSupportDescription: "Open the support ticket bot",
