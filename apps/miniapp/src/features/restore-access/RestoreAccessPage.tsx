...
import { useRestoreAccessPageModel } from "@/features/restore-access/model/useRestoreAccessPageModel";
...
export function RestoreAccessPage() {
  ...
  if (!model.hasSession && !model.isSessionLoading) {
    return <SessionMissing />;
  }

  if (model.isSessionLoading) {
    return (
