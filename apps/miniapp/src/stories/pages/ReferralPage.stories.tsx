...
const DOC_BODY = [
  ...
  "**Scenarios:** presets in [`page-contracts`](../../../storybook/page-contracts/) for `readyScenario` and `loggedOutScenario`, plus story-local loading and HTTP error overrides for `referralLink` / `referralStats` and a local no-upsell plan variant.",
