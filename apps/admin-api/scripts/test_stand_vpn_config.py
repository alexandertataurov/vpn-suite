...
Run from repo root: python apps/admin-api/scripts/test_stand_vpn_config.py
...
# Allow importing app when run as script from apps/admin-api/
_SCRIPT_DIR = Path(__file__).resolve().parent
_BACKEND = _SCRIPT_DIR.parent
if str(_BACKEND) not in sys.path:
    sys.path.insert(0, str(_BACKEND))

# Load .env from repo root (parent of apps/admin-api)
